...
build:
	...
	mv $(pwd)/build/bin/ChatY-arm64.app $(pwd)/build/bin/ChatY_$(version)_macos_apple.app
	mv $(pwd)/build/bin/ChatY-amd64.app $(pwd)/build/bin/ChatY_$(version)_macos_intel.app
